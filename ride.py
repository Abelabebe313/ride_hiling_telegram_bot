...
async def start(message: Message, state: FSMContext):
    ...
    if not redis_conn.exists(user_key):
        ...
        await message.answer('🚗 Hello👋, Welcome  to RideHailBot!', reply_markup=menu_Passenger)
    else:
...
async def process_Contact_info(message: Message, state: FSMContext):
    ...
    await message.answer("please share you contact:-", reply_markup=Contact)
...
def get_menu_Passenger_markup():
    menu_Passenger = ReplyKeyboardMarkup(resize_keyboard=True,
        keyboard=[
                    ...
                    [KeyboardButton(text="View Book History and Receipts")],
...
# ----------------->  View Book History and Receipts for driver <-----------------------
...
# -----------------    View Book History and Receipts for passenger  ----------------------------
